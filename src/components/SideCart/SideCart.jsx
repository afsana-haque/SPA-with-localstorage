...
const SideCart = ({ watchTime }) => {
    ...
    useEffect(() => {
        const getWatchTimeFormStorage = localStorage.getItem("watchTime");
        setTime(getWatchTimeFormStorage);
    ...
    return (
        <div>
            ...
            <dutton onClick={() => handleBreakTime(15)}
                className="w-25 btn-circle m-1 btn btn-info">15
            </dutton>
